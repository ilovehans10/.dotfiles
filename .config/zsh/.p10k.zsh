# Generated by Powerlevel10k configuration wizard on 2023-07-27 at 12:34 CDT.
...
# lightest, 24h time, slanted separators, slanted heads, round tails, 2 lines, dotted,
# full frame, sparse, many icons, concise, transient_prompt, instant_prompt=quiet.
